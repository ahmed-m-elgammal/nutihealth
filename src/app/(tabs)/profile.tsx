                    ...
                    <View className="flex-row gap-3">
                        ...
                        <Card className="flex-1 border-blue-500/20 bg-blue-500/5">
                            <CardContent className="items-center p-4">
                                ...
                                <Heading className="text-2xl text-blue-600 dark:text-blue-400">{goalWeight}kg</Heading>
                    ...
                    <View className="mt-3 flex-row gap-3">
                        <Card className="flex-1 border-amber-500/20 bg-amber-500/5">
                            <CardContent className="items-center p-4">
                                ...
                                <Heading className="text-2xl text-amber-600 dark:text-amber-500">{streak} days</Heading>
                        ...
                        <CardHeader className="flex-row items-center justify-between pb-3">
                            <View className="flex-row items-center">
                                ...
                                <View>
                                    ...
                                    <Caption className="text-emerald-600/80">Your current nutrition program</Caption>
                                </View>
                            </View>
                    ...
                    <CardContent className="space-y-3">
                        <View className="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4">
                            <View className="flex-row items-center">
                                ...
                                <View className="flex-1">
                                    <Body className="font-bold text-amber-700 dark:text-amber-500">7-Day Streak!</Body>
