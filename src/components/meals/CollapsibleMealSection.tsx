...
type CollapsibleMealSectionProps = {
    title: string;
    calories: number;
    foods: MealSectionFood[];
    expanded: boolean;
    onToggle: () => void;
    onFoodPress: (food: MealSectionFood) => void;
    onDeleteFood: (food: MealSectionFood) => void;
    onDuplicateFood: (food: MealSectionFood) => void;
    onEditFood: (food: MealSectionFood) => void;
    onAddNoteFood: (food: MealSectionFood) => void;
};
