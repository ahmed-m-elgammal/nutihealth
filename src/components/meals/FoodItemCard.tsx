...
export default function FoodItemCard({ item, onPress, onDelete, onDuplicate, onEdit, onAddNote }: FoodItemCardProps) {
                ...
                >
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <View style={{ flex: 1, paddingRight: 8 }}>
                            ...
                            {item.note ? (
                                <Text style={{ color: '#0f172a', fontSize: 12, marginTop: 6 }} numberOfLines={1}>
                                    Note: {item.note}
                                </Text>
                            ) : null}
                        </View>
