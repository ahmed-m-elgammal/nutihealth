...
const buildWorkoutExercise = (
    ...
    return {
        ...
        videoUrl: linkedExercise?.videoUrl || linkedExercise?.imageUrl || libraryExercise?.videoUrl || libraryExercise?.thumbnailUrl,
        thumbnailUrl: linkedExercise?.imageUrl || linkedExercise?.videoUrl || libraryExercise?.thumbnailUrl || libraryExercise?.videoUrl,
        sets: parsedSets,
        reps,
        repType,
