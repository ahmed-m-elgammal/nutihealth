...
export const EXPO_PUBLIC_ENABLE_AI = readBooleanEnv('EXPO_PUBLIC_ENABLE_AI', NODE_ENV !== 'production');
export const EXPO_PUBLIC_ENABLE_BARCODE = readBooleanEnv('EXPO_PUBLIC_ENABLE_BARCODE', true);
export const EXPO_PUBLIC_ENABLE_CAMERA = readBooleanEnv('EXPO_PUBLIC_ENABLE_CAMERA', true);
export const EXPO_PUBLIC_ENABLE_NOTIFICATIONS = readBooleanEnv('EXPO_PUBLIC_ENABLE_NOTIFICATIONS', true);
export const EXPO_PUBLIC_ENABLE_ANALYTICS = readBooleanEnv('EXPO_PUBLIC_ENABLE_ANALYTICS', false);
